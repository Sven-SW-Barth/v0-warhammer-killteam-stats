-- Recalculate all historical Elo ratings in chronological order
...
BEGIN
    ...
    LOOP
        ...
        -- K=32 for first 20 games, K=24 for 20-50 games, K=16 for 50+ games
    ...
    RAISE NOTICE 'Elo ratings recalculated successfully for all historical games';
END $$;
