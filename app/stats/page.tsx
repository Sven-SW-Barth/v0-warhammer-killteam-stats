...
export default async function StatsPage({
  ...
  const startDate = (searchParams.startDate as string) || defaultStartDate
  const endDate = (searchParams.endDate as string) || today
  const countryId = searchParams.country as string
  const killzoneId = searchParams.killzone as string
  const critopId = searchParams.critop as string
  ...
  const [{ data: games }, { data: countries }, { data: killzones }, { data: tacops }, { data: critops }] =
    await Promise.all([
      gamesQuery,
