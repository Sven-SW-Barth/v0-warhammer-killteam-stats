...
1. Clone the repository: ```bash git clone cd killteam-stats ```
...
To recalculate all Elo ratings, run: ```sql scripts/011_recalculate_elo_fixed.sql ```
Contributing
...
No personal information (email, real names, etc.) is collected. See our Privacy Policy for more details.
License
